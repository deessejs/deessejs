export declare const list: import("@orpc/server").DecoratedProcedure<import("../base-context.js").BaseContext & Record<never, never>, import("../base-context.js").BaseContext, import("@orpc/server").Schema<unknown, unknown>, import("@orpc/server").Schema<{
    templates: {
        slug: string;
        name: string;
        description: string;
...
export declare const templatesRouter: {
