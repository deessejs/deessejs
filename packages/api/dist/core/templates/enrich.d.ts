 ...
 */
export declare const resolveLabels: (repoTopics: string[] | undefined, entryLabels: string[] | undefined) => string[];
/**
 ...
 */
export declare function enrich(registry: ReadonlyArray<TemplateV1>): Promise<EnrichedTemplate[]>;
