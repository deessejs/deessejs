 ...
 * client-facing paths.
 */
export declare const API_BASE_PATH_V1: "/api/v1";
/** Active version. Alias of the latest released base path. */
export declare const API_BASE_PATH: "/api/v1";
export declare const API_RPC_PATH: "/api/v1/rpc";
export declare const API_AUTH_PATH: "/api/v1/auth";
export declare const API_HEALTH_PATH: "/api/v1/health";
export declare const API_READY_PATH: "/api/v1/ready";
