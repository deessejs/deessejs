 ...
 */
export { type Bcp47, defaultLocale, locales, isSupportedLocale, openGraphLocale, availableLanguageLabel, LOCALE_LABELS, } from "./_locales.js";
export { routing } from "./routing.js";
export type { Routing } from "./routing.js";
export { Link, redirect, usePathname, useRouter, getPathname, } from "./navigation.js";
export { LocaleSwitcher } from "./locale-switcher.js";
export type { LocaleSwitcherProps } from "./locale-switcher.js";
export { sharedMessages, type SharedMessages, type SharedLocale, } from "./shared/index.js";
