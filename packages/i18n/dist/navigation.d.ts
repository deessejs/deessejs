export declare const Link: import("react").ForwardRefExoticComponent<Omit<{
    ...
    forcePrefix?: boolean;
}, type?: import("next/dist/client/components/redirect-error.js").RedirectType | undefined) => never, usePathname: () => string, useRouter: () => {
    push: (href: string | {
        pathname: string;
        query?: import("next-intl/navigation").QueryParams;
    }, options?: (Partial<import("next/dist/shared/lib/app-router-context.shared-runtime.js").NavigateOptions> & {
        locale?: import("next-intl").Locale;
    }) | undefined) => void;
    replace: (href: string | {
        pathname: string;
    ...
    prefetch: (href: string | {
        pathname: string;
        query?: import("next-intl/navigation").QueryParams;
    }, options?: (Partial<import("next/dist/shared/lib/app-router-context.shared-runtime.js").PrefetchOptions> & {
        locale?: import("next-intl").Locale;
    }) | undefined) => void;
    back(): void;
    forward(): void;
