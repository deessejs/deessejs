 ...
 */
export declare const asSessionToken: (s: string) => SessionToken;
export declare const asSessionRowId: (s: string) => SessionRowId;
export declare const asCurrentSessionToken: (s: string) => CurrentSessionToken;
export {};
