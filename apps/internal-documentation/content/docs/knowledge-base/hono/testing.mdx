---
title: 'Hono testing'
description: 'A study of Hono''s testing patterns. Built on'
---
...
- `app.request(new Request("http://...", { ... }))` , pass a
  ...
  for example multipart/form-data, or when you need to set a custom
...
tests that Hono itself routes correctly. It doesn't test
that the app's middleware runs, that the composer's
...
mocking any of the in-house code.
