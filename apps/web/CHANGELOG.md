...
- b456379: Add the `/pricing` route on the marketing site, implementing the three-layer catalog pricing strategy defined in `documents/internal/product/pricing.md`.
