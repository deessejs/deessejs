...
export const ENTERPRISE_FAQ: ReadonlyArray<EnterpriseFaqItem> = [
  {
    ...
    answer:
      "A senior engineer is assigned to your engagement for its full duration. They join a shared Slack Connect or Microsoft Teams channel you already use, available during US and European business hours, and own every template shipped. Weekly syncs are scheduled in your timezone. Issues route to a person, not a queue.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes. We maintain a standard DPA and respond to vendor security questionnaires in under 5 business days. Signed NDAs, security review packets, and procurement paperwork do not slow the engagement.",
  },
]
