...
export const TRUST_BADGES: ReadonlyArray<TrustBadge> = [
  {
    ...
    detail: "Standard template ready to sign. Custom terms reviewed within three business days.",
    href: "mailto:support@deessejs.com?subject=DPA%20request",
  },
  {
    label: "Security questionnaires",
    detail: "Returned within five business days. No legalese, no redirect to a portal.",
